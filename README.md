...
x64 Version: (HIGHLY RECOMENDED; Faster) https://ci.appveyor.com/project/CarJem/maniaceditor-generationsedition-ebcr5
x86 Version: (Backwards Compatible; Slower) https://ci.appveyor.com/project/CarJem/maniaceditor-generationsedition
