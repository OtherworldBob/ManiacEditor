...
{
    public class Crane : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency)
        {
            bool fliph = false;
            bool flipv = false;
            var editorAnim = e.LoadAnimation2("Crane", d, 0, -1, fliph, flipv, false);
            var editorAnim2 = e.LoadAnimation2("Crane", d, 1, -1, fliph, flipv, false);
